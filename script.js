...
// Popola macro e categorie in base al tipo
...
$("#form-movimento").addEventListener("submit", (e)=>{
  ...
  if(tipo!=="entrata" && (!macro || !categoria)){ alert("Seleziona macro e sotto-categoria."); return; }
...
function aggiornaRiepilogo(){
  ...
  document.getElementById("saldo-mese").textContent = `Entrate: € ${entrate.toFixed(2)} – Spese: € ${spese.toFixed(2)} → Saldo: € ${saldo.toFixed(2)}`;
}
